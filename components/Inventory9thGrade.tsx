...
const initialClassrooms: Classroom[] = [
    { id: '1', name: '9A', items: getInitialItems({ chairs: {usable: 40, broken: 2}, desks: {usable: 40, broken: 1}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '2', name: '9B', items: getInitialItems({ chairs: {usable: 40, broken: 0}, desks: {usable: 40, broken: 0}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '3', name: '9C', items: getInitialItems({ chairs: {usable: 40, broken: 5}, desks: {usable: 40, broken: 3}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '4', name: '9D', items: getInitialItems({ chairs: {usable: 40, broken: 1}, desks: {usable: 40, broken: 1}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '5', name: '9E', items: getInitialItems({ chairs: {usable: 40, broken: 0}, desks: {usable: 40, broken: 0}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
];
...
export const Inventory9thGrade: React.FC = () => {
    ...
    const handleDownloadPdf = () => {
        ...
        const title = "R/EMB/ROYAL COLLEGE - Grade 9 Inventory";
        ...
        doc.save('grade_9_classroom_inventory.pdf');
    };

    return (
        <div className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="text-xl md:text-2xl font-bold text-slate-700 mb-4 border-b pb-3">Manage Classroom Inventory (Grade 9)</h3>
            ...
            <form onSubmit={handleAddClassroom} className="flex items-end gap-4 p-4 bg-slate-50 rounded-lg">
                <div className="flex-grow">
                    <label htmlFor="newClassNameGrade9" className="block text-sm font-medium text-slate-600 mb-1">New Class Room Name</label>
                    <input id="newClassNameGrade9" type="text" value={newClassName} onChange={(e) => setNewClassName(e.target.value)} placeholder="e.g., 9F" className="w-full px-3 py-2 border border-slate-300 rounded-lg" required />
                </div>
