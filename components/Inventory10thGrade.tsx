...
const initialClassrooms: Classroom[] = [
    { id: '1', name: '10A', items: getInitialItems({ chairs: {usable: 40, broken: 2}, desks: {usable: 40, broken: 1}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '2', name: '10B', items: getInitialItems({ chairs: {usable: 40, broken: 0}, desks: {usable: 40, broken: 0}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '3', name: '10C', items: getInitialItems({ chairs: {usable: 40, broken: 5}, desks: {usable: 40, broken: 3}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '4', name: '10D', items: getInitialItems({ chairs: {usable: 40, broken: 1}, desks: {usable: 40, broken: 1}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
    { id: '5', name: '10E', items: getInitialItems({ chairs: {usable: 40, broken: 0}, desks: {usable: 40, broken: 0}, teacherDesks: {usable: 1, broken: 0}, teacherChairs: {usable: 1, broken: 0}, whiteboards: {usable: 1, broken: 0}, cupboards: {usable: 2, broken: 0} })},
];
...
export const Inventory10thGrade: React.FC = () => {
    ...
    const handleDownloadPdf = () => {
        ...
        const title = "R/EMB/ROYAL COLLEGE - Grade 10 Inventory";
        ...
        doc.save('grade_10_classroom_inventory.pdf');
    };

    return (
        <div className="bg-white p-6 rounded-xl shadow-md">
            <h3 className="text-xl md:text-2xl font-bold text-slate-700 mb-4 border-b pb-3">Manage Classroom Inventory (Grade 10)</h3>
            ...
            <form onSubmit={handleAddClassroom} className="flex items-end gap-4 p-4 bg-slate-50 rounded-lg">
                <div className="flex-grow">
                    <label htmlFor="newClassNameGrade10" className="block text-sm font-medium text-slate-600 mb-1">New Class Room Name</label>
                    <input id="newClassNameGrade10" type="text" value={newClassName} onChange={(e) => setNewClassName(e.target.value)} placeholder="e.g., 10F" className="w-full px-3 py-2 border border-slate-300 rounded-lg" required />
                </div>
